...
const CarDetails = () => {
  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gpa-8 lg:gap-12'>
        ...
        <motion.div
          ...
          <motion.div
            ...
            <h1 className='tetx-3xl font-bold'> {car.brand}{car.model} </h1>
        ...
        <motion.form
          ...
          <p className='flexl items-center justify-between text-2xl text-gray-800 font-semibold'>
